...
Simple CRUD app for managing Books, Members, and Loans (issue/return) using Laravel and SQLite.

### Quick Start

1. Requirements: PHP 8.2+, Composer
2. Install dependencies: already installed via create-project
3. Configure environment: `.env` is pre-copied; using SQLite at `database/database.sqlite`
